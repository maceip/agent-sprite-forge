...
> Cursor / Grok / Codex 설치는 `python scripts/install.py`와 marketplace 매니페스트로 바뀌었습니다. Install 절차는 [English README](./README.md)와 [`docs/marketplace.md`](./docs/marketplace.md)를 기준으로 하세요.

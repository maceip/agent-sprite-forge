...
> Cursor / Grok / Codex 安裝方式已改為 `python scripts/install.py` 與 marketplace 目錄。請以 [English README](./README.md) 的 Install 與 [`docs/marketplace.md`](./docs/marketplace.md) 為準。

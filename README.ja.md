...
> Cursor / Grok / Codex の導入は `python scripts/install.py` と marketplace マニフェストに移行しました。Install 手順は [English README](./README.md) と [`docs/marketplace.md`](./docs/marketplace.md) を正とします。
